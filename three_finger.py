...
def run_hand_gestures_3fing():
    ...
    mp_hands = mp.solutions.hands #performs the hand recognition algorithm. So we create the object and store it in mpHands.
    hands = mp_hands.Hands(
        static_image_mode=use_static_image_mode,
        max_num_hands=2, #multiple hand detecion
...
def draw_landmarks(image, landmark_point):
    ...
    for index, landmark in enumerate(landmark_point):
        ...
        if index == 4:  # Thumb: fingertip
            cv.circle(image, (landmark[0], landmark[1]), 8, (0, 255, 0),-1)
...
def draw_info_text(image, brect, handedness, hand_sign_text,finger_gesture_text):
    cv.rectangle(image, (brect[0], brect[1]), (brect[2], brect[1] - 22),(0, 255, 0), -1)
